...
const withMentions = (editor: CustomTypes['Editor']) => {
...
const insertMention = (editor: CustomTypes['Editor'], character: string) => {
...
const Mention: FC<{attributes: any; element: any}> = ({ attributes, children, element }) => {
